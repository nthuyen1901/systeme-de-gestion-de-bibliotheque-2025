...
<head>
  ...
  <title>Système de gestion de bibliothèque || Voir les étudiants</title>
...
<body onload="preloader()">
  ...
  object-fit: cover;" alt="Student Profile Image">
          ...
          ?>
            <p class="error">Aucun étudiant n'a encore été ajouté</p>

          <?php
          }
        } else {
          ?>
          <p class="error">Veuillez vous connecter pour afficher la liste des étudiants</p>
          <script>
            setTimeout(() => {
