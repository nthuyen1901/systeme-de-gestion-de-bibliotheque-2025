...
if (isset($_POST['update-book'])) {
  ...
  if ($result) {
    $error['book-msg'] = "Les détails du livre ont été mis à jour avec succès";
?>
    <script>
      setTimeout(() => {
  ...
  <?php
    ...
    $error['book-msg'] = "Les détails de votre livre n'ont pas été mis à jour. Veuillez réessayer";
  ?>
    <script>
      setTimeout(() => {
        document.querySelector(".error").style.display = "none";
...
<head>
  ...
  <title>Système de gestion de bibliothèque|| Mettre à jour les détails du livre</title>
    ...
    <div class="control-panel">
      ...
      <div class="container">
        ...
        <div class="update-book-form data-form">
          <h4>Mettre à jour les détails du livre</h4>
