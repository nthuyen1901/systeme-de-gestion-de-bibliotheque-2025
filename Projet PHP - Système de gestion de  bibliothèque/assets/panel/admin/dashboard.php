...
<head>
  ...
  <title>Système de gestion de bibliothèque || Tableau de bord du bibliothécaire</title>
...
<body onload="preloader()">
  ...
  <div class="sidebar close">
    <ul class="nav-links">
      ...
      <li class="active">
        ...
        <ul class="sub-menu">
          <li><a href="admin-pages/add-book.php">Ajouter un livre</a></li>
          <li><a href="admin-pages/view-book.php">Voir les livres</a></li>
        </ul>
      </li>
      <li>
        <div class="iocn-link">
        ...
        <ul class="sub-menu blank">
          <li><a href="admin-pages/category.php">Catégorie</a></li>
        </ul>
      </li>
      <li>
        <div class="iocn-link">
        ...
        <ul class="sub-menu blank">
          <li><a href="admin-pages/issue-book.php">Émettre des livres</a></li>
        </ul>
      </li>
      <li>
        <a href="admin-pages/view-issue-book.php">
          <i class='bx bxs-grid'></i>
          <span class="link_name">Voir tous les livres émis</span>
        </a>
        <ul class="sub-menu blank">
          <li><a href="admin-pages/view-issue-book.php">Voir tous les livres émis</a></li>
        </ul>
      </li>
      <li>
        ...
        <ul class="sub-menu blank">
          <li><a href="admin-pages/view-return-book.php">Voir tous les livres retournés</a></li>
        </ul>
      </li>
      <li>
        ...
        <ul class="sub-menu blank">
          <li><a href="admin-pages/view-book-request.php">Voir les demandes de livres</a></li>
        </ul>
      </li>
      <li>
        <div class="iocn-link">
        ...
        <ul class="sub-menu">
          <li><a href="admin-pages/add-user.php">Ajouter des utilisateurs</a></li>
          <li><a href="admin-pages/view-user.php">Voir tous les utilisateurs</a></li>
        </ul>
      </li>
  ...
  <section class="home-section">
    <div class="home-content">
      ...
      <div class="logout">
        <button><a href="admin-pages/logout.php">Se déconnecter</a></button>
      </div>
    </div>
      ...
      <div class="panel-container">
        ...
        <div class="return-books panel">
          <div class="data">
            <span><?php
                  ...
                  ?></span>
            <label for="">Livres retournés</label>
          </div>
          <div class="icon">
            <i class='bx bx-book'></i>
          </div>
        ...
        <div class="all-books panel">
          <div class="data">
            ...
            <label for="">Total des livres</label>
          </div>
          <div class="icon">
            <i class='bx bx-book'></i>
          </div>
        ...
        <div class="manage-users panel">
          <div class="data">
            ...
            <label for="">Gérer les utilisateurs</label>
          </div>
          <div class="icon">
            <i class='bx bxs-group'></i>
          </div>
