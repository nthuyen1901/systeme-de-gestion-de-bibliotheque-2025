...
if (isset($_POST['lib-login'])) {
  ...
  if ($password == '') {
    $error['pass'] = "Ce champ ne doit pas être vide";
  }
  if ($emailcount > 0) {
...
<head>
  ...
  <title>Système de gestion de bibliothèque|| Formulaire de connexion pour le bibliothécaire</title>
...
<body onload="preloader()">
  ...
  <section class="login">
    <form class="login-form" action="<?php echo htmlentities($_SERVER['PHP_SELF']); ?>" method="POST">
      <h4>Connexion bibliothécaire</h4>
      ...
      <div class="input-form">
        ...
        <p>Vous n'avez pas de compte ? <a href="librarian-signup.php">Inscrivez-vous maintenant</a></p>
      </div>
    </form>
  </section>
</body>
